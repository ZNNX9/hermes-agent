...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("gow", "Run Group of Wisdom multi-model discussion", "Session",
               aliases=("gow+", "gowplus", "group-wisdom", "group-of-wisdom", "group_wisdom"),
               args_hint="<question>", gateway_only=True),
